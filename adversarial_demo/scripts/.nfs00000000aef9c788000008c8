#!/usr/bin/env bash
#
# End-to-end test of every attack type on YFCC (10 images x 2 budgets) in a SINGLE
...
ATTACK_BUDGETS=( 0.0314 )           # 4/255, 8/255
GEOSHIELD_EPSILONS=( 8 )                 # matching GeoShield epsilon (0-255 scale)
BUDGETS="[$(IFS=,; echo "${ATTACK_BUDGETS[*]}")]"   # "[0.0157,0.0314]" override string

# GeoShield generation settings (YFCC).
GEOSHIELD_ATTACK_NAME="geoshield"
GEOSHIELD_STEPS=100
DATASET_ROOT="/Data/mathias.ollu/hf_cache/datasets/YFCC100M/yfcc4k"
GEOSHIELD_CLEAN_DIR="/Data/mathias.ollu/hf_cache/clean_yfcc_images"
GEOSHIELD_OUTPUT_BASE="/Data/mathias.ollu/hf_cache/attacked_yfcc_images_geoshield"
