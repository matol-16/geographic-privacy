...
ATTACK_TYPES=(unidef)
N_IMAGES=200
RESULTS_DIR="${PROJECT_DIR}/results/baselines/results_unidef_nofdje_100_8"
PLOTS_DIR="${RESULTS_DIR}/plots"
PARALLEL_WORKERS=4
USE_REAL_GPS=false
#model type: "" for RFM, "diffusion" for diffusion, "flow" for flow
MODEL_TYPE=""
# UniDef ablation "w/o FDJE" (paper Table 4): CDD objective with exact backprop through
# the denoiser instead of the finite-difference Jacobian estimate.
USE_FDJE=false
OVERRIDES=(
